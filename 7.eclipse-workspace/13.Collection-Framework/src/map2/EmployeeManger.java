...
public class EmployeeManger {
	...
	public Employee removeEmployee(String employeeId) {
		...
		if(removedEmployee != null) {
			...
			System.out.println("⚠️ 해당 사번의 직원이 찾을 수 없습니다: "+employeeId);
		}
	...
	public void showAllEmployees() {
		if(employees.isEmpty()) {
			System.out.println("동록된 직원이 없습니다.");
			return;
		}
		...
		employees.entrySet().stream().sorted(Map.Entry.comparingByKey())
