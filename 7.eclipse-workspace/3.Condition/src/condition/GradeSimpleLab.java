...
public class GradeSimpleLab {
	...
	public static void main(String[] args) {
		...
		System.out.println("국어 점수 : " +koreaScore + "점");
		System.out.println();
		...
		/*
		 * 	%d : 정수
		 *  %f : 실수 (float, double) - 기본 소수점 6자리, (예: %.1f <-- 소수점 첫 째 자리까지)
		 *  %s : 문자열
		 *  %c : 문자
		 *  %n : 줄바꿈
		 */
		...
		System.out.println("🔥 강점 과목: "+ maxsub +"("+max+"점)" );
		System.out.println("💪 집중 필요 과목: "+ minsub +"("+min+"점)" );
