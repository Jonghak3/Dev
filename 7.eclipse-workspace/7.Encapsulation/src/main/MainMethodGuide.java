...
public class MainMethodGuide {
	...
	//클래스 변수 - 모든 인스턴스가 공유
	private static String applicationName = "관리 시스템";
	...
	private static void commandLineArguement(String[] args) {
		...
		if(args.length == 0) {
			...
			System.out.println(" 사용 예 : java MainMethodGuide server 8080 production");
			return;
		}
