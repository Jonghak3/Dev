...
public class Member extends Person {
	...
	private static final int MAX_BORROW = 3;	//최대 대출 가능한 권수 
	...
	public void borrowBook(String isbn) throws LibraryException {
		//최대 대출 권수 확인
		if(!canBorrow()) {
			throw new LibraryException("최대 대출 권수 ("+MAX_BORROW+"권)을 초과했습니다.");
		}
	...
	public String toString() {
		...
		return super.toString()+
				String.format(", 가입일: %s, 대출중: %d권", 
						joinDate.format(formatter), borrowedBooks.size());
	}
