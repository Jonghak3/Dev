...
public class ShopStart5 {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("=== 쇼핑몰 상품 정보(클래스 사용) ===");
		 * System.out.println("상품명: "+inventory[0].name+" | 가격: "+inventory[0].
		 * price+"원 | 재고 : "+inventory[0].stock+"개 | 카테고리 : "+inventory[0].category);
		 * System.out.println("상품명: "+inventory[1].name+" | 가격: "+inventory[1].
		 * price+"원 | 재고 : "+inventory[1].stock+"개 | 카테고리 : "+inventory[1].category);
		 */
